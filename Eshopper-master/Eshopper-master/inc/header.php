					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li class="dummy"><a href="javascript:void(0)"><i class="fa fa-phone"></i> +593959404624</a></li>
								<li class="dummy"><a href="javascript:void(0)"><i class="fa fa-envelope"></i> christlop_bsc@hotmail.com</a></li>
                    ...
                    <div class="site-logo">
                        <figure id="neon">
                          <svg width="100%" height="100%" viewBox="0 0 148 128">
                            ...
                            <polygon id="logo-hexagon" fill="#f8b864" points="64 128 8.574 96 8.574 32 64 0 119.426 32 119.426 96" mask="url(#circle-mask)"></polygon>
					...
					<div class="col-sm-8">
						...
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="<?php echo $wish ?>"><i class="glyphicon glyphicon-heart"></i> Favoritos&nbsp;<span class="badge" id="wish_count">0</span></a></li>
								<!--<li><a href="checkout.php"><i class="fa fa-crosshairs"></i> Checkout</a></li>-->
								<li><a href="cart.php"><i class="fa fa-shopping-cart"></i> Carrito&nbsp;<span class="badge" id="count">0</span></a></li>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li><a href="shop.php">Todos los servicios</a></li>

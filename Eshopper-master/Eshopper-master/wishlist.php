<?php include("inc/header.php"); ?>
					...
					<div class="panel-title">
						<div class="row">
							<div class="col-xs-6 col-lg-6">
								<h5><span class="glyphicon glyphicon-shopping-cart"></span>Tus favoritos</h5>
							</div>
							<div class="col-xs-6 col-lg-6">
					...
					<div class="row">
						...
						<div class="col-xs-4">
							...
							<div class="col-xs-2">
								...
								<span class="glyphicon glyphicon-shopping-cart"></span> <span class="hidden-xs">Agregar al carrito</span>
								</button>
							</div>
							<div class="col-xs-2">
	...
	$(document).ready(function(){
		...
		$(".add").on("click",function(){
			...
			$.ajax({
				...
				success: function($wish){
					if($wish > 0){
						...
						notif({
						msg:"
								El producto ya está añadido en el carrito. !!!",
						type:"warning",
						width:330,
						height:40,
						timeout:2000,
	     ...
	     <script>
	       		   <?php if($count_wish < 1){
					   echo "$('.panel-body').html('<center><h1>No se pudo agregar a favoritos</h1></center>');";
				   } ?>
